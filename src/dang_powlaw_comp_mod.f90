module dang_powlaw_comp_mod
  use dang_component_mod
  use dang_mixmat_1d_mod
  implicit none
  
  private
  public dang_powlaw_comp

  type, extends (dang_comp) :: dang_powlaw_comp
   contains
     procedure :: S  => eval
  end type dang_powlaw_comp

  interface dang_powlaw_comp
     procedure constructor
  end interface dang_powlaw_comp
...
contains
  ...
  function constructor(dpar,component)
    ...
    class(dang_powlaw_comp), pointer :: constructor
  ...
  function eval(self, nu, band, pol, theta, pixel)
    ...
    implicit none
    class(dang_powlaw_comp), intent(in)           :: self
...
end module dang_powlaw_comp_mod
