program dust_fit
    ...
    do k = 1, nmaps
        ...
        do iter = 1, niter
            ...
            ! ! write(*,*) 'LU Decomp'
            ! ! call LUDecomp(mat_test,mat_l,mat_u,3)
            ...
            ! call cholesky_decomp(mat_test, mat_l, mat_d, 3)
  ...
  contains
    ...
    subroutine cholesky_decomp(mat,low,mat_d,n)
        implicit none
        real(dp), dimension(:,:), intent(in)  :: mat
        real(dp), dimension(:,:), intent(out) :: low, mat_d
